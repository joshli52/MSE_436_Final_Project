...
This Intelligent Decision Support System (IDSS) helps conference organizers select the optimal U.S. conference host city before venue booking decisions are made.
...
The system supports one decision:

Which U.S. city should be selected as the conference host city?
# MSE_436_Final_Project
